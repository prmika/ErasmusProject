...
export class WarehouseService {
  ...
  getWarehouses(): Observable<Warehouse[]> {
    return this.http.get<Warehouse[]>("https://localhost:44343/api/Warehouses")
  }

  getWarehouse(id: string): Observable<Warehouse> {
    const url = `https://localhost:44343/api/Warehouses/${id}`;
  ...
  addWarehouse(warehouse: Warehouse): Observable<Warehouse> {
    const url = 'https://localhost:44343/api/Warehouses'
