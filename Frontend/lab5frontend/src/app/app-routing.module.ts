...
const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [AuthGuard],
  }, //Go to page that shows all the warehouses
  {
    path: 'warehouse/create', component: WarehouseAddComponent,
    canActivate: [AuthGuard],
  }, //Go to page to create a warehouse
  {
    path: 'warehouse/:id', component: WarehouseDetailComponent,
    canActivate: [AuthGuard],
  }, //Go to page that shows a specific warehouse with a form to edit the data
  {
  ...
  },
  {
    ...
    canActivate: [AuthGuard],
  }, //Go to page that shows a specific user with a form to edit the data
  {
    path: 'roles',
